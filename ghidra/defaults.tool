    ...
    <TOOL TOOL_NAME="CodeBrowser" INSTANCE_NAME="">
        <OPTIONS>
            <CATEGORY NAME="Key Bindings">
                <WRAPPED_OPTION NAME="Create Pointer (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="pressed P" />
                ...
                <WRAPPED_OPTION NAME="Edit Comments (CommentsPlugin)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="meta pressed SLASH" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                ...
                <WRAPPED_OPTION NAME="Create Array (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="pressed OPEN_BRACKET" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Next Matching Byte Values (NextPrevCodeUnitPlugin)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="shift pressed N" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Duplicate Component (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="alt pressed D" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Edit Variable Comment (FunctionPlugin)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="meta pressed SLASH" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Edit (DataTypeManagerPlugin)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="shift pressed E" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Duplicate Multiple of Component (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="alt pressed M" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Clear Components (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="pressed C" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Rename Symbol (SymbolTreePlugin)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="pressed F2" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Rename (DataTypeManagerPlugin)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="pressed F2" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Clear With Options (ClearPlugin)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="shift pressed C" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Delete Components (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="pressed DELETE" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Define double (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="shift pressed D" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Insert Undefined Byte (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="alt pressed U" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Edit Function Signature (DecompilePlugin)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="meta pressed L" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Data Settings (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="shift pressed T" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Unpackage Component (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="pressed EQUALS" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Show Numbers In Hex (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="shift pressed H" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Edit Component Field (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="pressed F2" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Move Components Down (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="alt pressed DOWN" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Remove Equate (DecompilePlugin)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="pressed DELETE" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
                <WRAPPED_OPTION NAME="Move Components Up (Shared)" CLASS="ghidra.framework.options.WrappedActionTrigger">
                    <STATE NAME="KeyStroke" TYPE="string" VALUE="alt pressed UP" />
                    <STATE NAME="MouseBinding" TYPE="string" VALUE="" />
                </WRAPPED_OPTION>
            </CATEGORY>
            <CATEGORY NAME="Decompiler">
                <ENUM NAME="Analysis.Alias Blocking" TYPE="enum" CLASS="ghidra.app.decompiler.DecompileOptions$AliasBlockEnum" VALUE="None" />
                <STATE NAME="Analysis.Use inplace assignment operators" TYPE="boolean" VALUE="true" />
                <STATE NAME="Decompiler Max-Payload (MBytes)" TYPE="int" VALUE="256" />
                <ENUM NAME="Display.Comment style" TYPE="enum" CLASS="ghidra.app.decompiler.DecompileOptions$CommentStyleEnum" VALUE="CPPStyle" />
                <STATE NAME="Display.Maximum characters in a code line" TYPE="int" VALUE="300" />
                ...
                <STATE NAME="Max Entries per Jumptable" TYPE="int" VALUE="2048" />
                <STATE NAME="Max Instructions per Function" TYPE="int" VALUE="300000" />
            </CATEGORY>
            <CATEGORY NAME="Search">
                <STATE NAME="Search Limit" TYPE="int" VALUE="10000" />
            </CATEGORY>
            <CATEGORY NAME="Tool">
                <STATE NAME="Max Navigation History Size" TYPE="int" VALUE="100" />
            </CATEGORY>
        ...
        <PLUGIN_STATE CLASS="ghidra.app.plugin.core.script.GhidraScriptMgrPlugin">
            ...
            <ARRAY NAME="BundleHost_FILE" TYPE="string">
                ...
                <A VALUE="$USER_HOME/Library/ghidra/ghidra_11.4.2_PUBLIC/Extensions/deepcut-ghidra/ghidra_scripts" />
                <A VALUE="$GHIDRA_HOME/Features/PyGhidra/ghidra_scripts" />
                <A VALUE="$USER_HOME/Library/ghidra/ghidra_11.4.2_PUBLIC/Extensions/GhidrAssist/ghidra_scripts" />
                ...
                <A VALUE="$USER_HOME/Library/ghidra/ghidra_11.4.2_PUBLIC/Extensions/GhidrAssistMCP/ghidra_scripts" />
                ...
                <A VALUE="$USER_HOME/Library/ghidra/ghidra_11.4.2_PUBLIC/Extensions/codecut-gui/ghidra_scripts" />
            </ARRAY>
        ...
        <PLUGIN_STATE CLASS="ghidra.app.plugin.core.byteviewer.ByteViewerPlugin">
            ...
            <SAVE_STATE NAME="View_Widths" TYPE="SaveState">
                <View_Widths>
                    ...
                    <STATE NAME="Hex" TYPE="int" VALUE="354" />
                </View_Widths>
            </SAVE_STATE>
        </PLUGIN_STATE>
        ...
        <ROOT_NODE X_POS="0" Y_POS="38" WIDTH="1512" HEIGHT="867" EX_STATE="6" FOCUSED_OWNER="ByteViewerPlugin" FOCUSED_NAME="Bytes" FOCUSED_TITLE="Bytes: main_cpu_checkpoint">
            <SPLIT_NODE WIDTH="1512" HEIGHT="759" DIVIDER_LOCATION="749" ORIENTATION="VERTICAL">
                <SPLIT_NODE WIDTH="1621" HEIGHT="816" DIVIDER_LOCATION="148" ORIENTATION="VERTICAL">
                    ...
                    <SPLIT_NODE WIDTH="1512" HEIGHT="565" DIVIDER_LOCATION="143" ORIENTATION="HORIZONTAL">
                        <SPLIT_NODE WIDTH="216" HEIGHT="565" DIVIDER_LOCATION="640" ORIENTATION="VERTICAL">
                            <SPLIT_NODE WIDTH="216" HEIGHT="359" DIVIDER_LOCATION="502" ORIENTATION="VERTICAL">
                                <COMPONENT_NODE TOP_INFO="0">
                                    <COMPONENT_INFO NAME="Program Tree" OWNER="ProgramTreePlugin" TITLE="Program Trees" ACTIVE="true" GROUP="Default" INSTANCE_ID="3696568232483806526" />
                                </COMPONENT_NODE>
                                <COMPONENT_NODE TOP_INFO="0">
                                    <COMPONENT_INFO NAME="Symbol Tree" OWNER="SymbolTreePlugin" TITLE="Symbol Tree" ACTIVE="true" GROUP="Default" INSTANCE_ID="3696568232483806521" />
                                </COMPONENT_NODE>
                            </SPLIT_NODE>
                            <COMPONENT_NODE TOP_INFO="0">
                                <COMPONENT_INFO NAME="DataTypes Provider" OWNER="DataTypeManagerPlugin" TITLE="Data Type Manager" ACTIVE="true" GROUP="Default" INSTANCE_ID="3696568347869109545" />
                            </COMPONENT_NODE>
                        </SPLIT_NODE>
                        <SPLIT_NODE WIDTH="1292" HEIGHT="565" DIVIDER_LOCATION="785" ORIENTATION="VERTICAL">
                            <SPLIT_NODE WIDTH="1386" HEIGHT="638" DIVIDER_LOCATION="705" ORIENTATION="VERTICAL">
                                <SPLIT_NODE WIDTH="1292" HEIGHT="565" DIVIDER_LOCATION="464" ORIENTATION="HORIZONTAL">
                                    <COMPONENT_NODE TOP_INFO="0">
                                        <COMPONENT_INFO NAME="Listing" OWNER="CodeBrowserPlugin" TITLE="Listing:  main_cpu_checkpoint" ACTIVE="true" GROUP="Core" INSTANCE_ID="3696568347613256998" />
                                    </COMPONENT_NODE>
                                    <COMPONENT_NODE TOP_INFO="0">
                                        <COMPONENT_INFO NAME="Decompiler" OWNER="DecompilePlugin" TITLE="Decompile: FUN_0c01eca0" ACTIVE="true" GROUP="Default" INSTANCE_ID="3696568232483806527" />
                                        <COMPONENT_INFO NAME="Bytes" OWNER="ByteViewerPlugin" TITLE="Bytes: main_cpu_checkpoint" ACTIVE="true" GROUP="Default" INSTANCE_ID="3696568347613256993" />
                                        <COMPONENT_INFO NAME="Data Window" OWNER="DataWindowPlugin" TITLE="Defined Data" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347869109550" />
                                        <COMPONENT_INFO NAME="Defined Strings" OWNER="ViewStringsPlugin" TITLE="Defined Strings" ACTIVE="true" GROUP="Default" INSTANCE_ID="3696568347869109554" />
                                        <COMPONENT_INFO NAME="Equates Table" OWNER="EquateTablePlugin" TITLE="Equates Table" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347613256996" />
                                        <COMPONENT_INFO NAME="External Programs" OWNER="ReferencesPlugin" TITLE="External Programs" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347613256999" />
                                        <COMPONENT_INFO NAME="Functions Window" OWNER="FunctionWindowPlugin" TITLE="Functions" ACTIVE="true" GROUP="Default" INSTANCE_ID="3696568347613257002" />
                                        <COMPONENT_INFO NAME="Relocation Table" OWNER="RelocationTablePlugin" TITLE="Relocation Table" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347869109553" />
                                    </COMPONENT_NODE>
                                </SPLIT_NODE>
                                <SPLIT_NODE WIDTH="1386" HEIGHT="189" DIVIDER_LOCATION="495" ORIENTATION="HORIZONTAL">
                                    <COMPONENT_NODE TOP_INFO="0">
                                        <COMPONENT_INFO NAME="Data Type Preview" OWNER="DataTypePreviewPlugin" TITLE="Data Type Preview" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347869109543" />
                                    </COMPONENT_NODE>
                                    <COMPONENT_NODE TOP_INFO="0">
                                        <COMPONENT_INFO NAME="Virtual Disassembler - Current Instruction" OWNER="DisassembledViewPlugin" TITLE="Disassembled View" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347613256995" />
                                    </COMPONENT_NODE>
                                </SPLIT_NODE>
                            </SPLIT_NODE>
                            <COMPONENT_NODE TOP_INFO="0">
                                <COMPONENT_INFO NAME="Console" OWNER="ConsolePlugin" TITLE="Console" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347613256992" />
                                <COMPONENT_INFO NAME="Bookmarks" OWNER="BookmarkPlugin" TITLE="Bookmarks" ACTIVE="false" GROUP="Core.Bookmarks" INSTANCE_ID="3696568232483806525" />
                            </COMPONENT_NODE>
                        </SPLIT_NODE>
                    </SPLIT_NODE>
                </SPLIT_NODE>
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Function Call Trees" OWNER="CallTreePlugin" TITLE="Function Call Trees: FUN_0c01eca0" ACTIVE="true" GROUP="Default" INSTANCE_ID="3696568232483806522" />
                </COMPONENT_NODE>
            </SPLIT_NODE>
            <WINDOW_NODE X_POS="426" Y_POS="178" WIDTH="1033" HEIGHT="689">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Script Manager" OWNER="GhidraScriptMgrPlugin" TITLE="Script Manager" ACTIVE="false" GROUP="Script Group" INSTANCE_ID="3696568232483806523" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="423" Y_POS="144" WIDTH="927" HEIGHT="370">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Memory Map" OWNER="MemoryMapPlugin" TITLE="Memory Map" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568232483806511" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="383" Y_POS="7" WIDTH="1020" HEIGHT="1038">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Function Graph" OWNER="FunctionGraphPlugin" TITLE="Function Graph" ACTIVE="false" GROUP="Function Graph" INSTANCE_ID="3696568347869109555" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="550" Y_POS="206" WIDTH="655" HEIGHT="509">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Register Manager" OWNER="RegisterPlugin" TITLE="Register Manager" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347613257001" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="287" Y_POS="186" WIDTH="1424" HEIGHT="666">
                <SPLIT_NODE WIDTH="1408" HEIGHT="559" DIVIDER_LOCATION="573" ORIENTATION="HORIZONTAL">
                    <COMPONENT_NODE TOP_INFO="0">
                        <COMPONENT_INFO NAME="Symbol Table" OWNER="SymbolTablePlugin" TITLE="Symbol Table" ACTIVE="false" GROUP="symbolTable" INSTANCE_ID="3696568347869109551" />
                    </COMPONENT_NODE>
                    <COMPONENT_NODE TOP_INFO="0">
                        <COMPONENT_INFO NAME="Symbol References" OWNER="SymbolTablePlugin" TITLE="Symbol References" ACTIVE="false" GROUP="symbolTable" INSTANCE_ID="3696568347869109552" />
                    </COMPONENT_NODE>
                </SPLIT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="-1" Y_POS="-1" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Checksum Generator" OWNER="ComputeChecksumsPlugin" TITLE="Checksum Generator" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347613256997" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="-1" Y_POS="-1" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Function Tags" OWNER="FunctionTagPlugin" TITLE="Function Tags" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347869109546" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="-1" Y_POS="-1" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Comment Window" OWNER="CommentWindowPlugin" TITLE="Comments" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347869109549" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="-1" Y_POS="-1" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
            ...
            <WINDOW_NODE X_POS="0" Y_POS="0" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="PyGhidra" OWNER="PyGhidra" TITLE="PyGhidra" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347869109548" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="0" Y_POS="0" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Bundle Manager" OWNER="GhidraScriptMgrPlugin" TITLE="Bundle Manager" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568232483806524" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="0" Y_POS="0" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Source Files and Transforms" OWNER="SourceFilesTablePlugin" TITLE="Source Files and Transforms" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347613257000" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="0" Y_POS="0" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Jython" OWNER="Jython" TITLE="Jython" ACTIVE="false" GROUP="Default" INSTANCE_ID="3696568347869109547" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="0" Y_POS="0" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Function Call Graph" OWNER="FunctionCallGraphPlugin" TITLE="Function Call Graph" ACTIVE="false" GROUP="Function Call Graph" INSTANCE_ID="3696568347869109544" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
        </ROOT_NODE>
        <PREFERENCES>
            ...
            <PREFERENCE_STATE NAME="ghidra.app.plugin.core.functionwindow.FunctionTableModel:Name:Location:Function Signature:Function Size:">
                <XML NAME="COLUMN_DATA">
                    <Table_State>
                        <COLUMN NAME="ghidra.app.plugin.core.functionwindow.FunctionTableModel$NameTableColumn.Name" WIDTH="109" VISIBLE="true" />
                        <COLUMN NAME="ghidra.util.table.field.AddressTableColumn.Location" WIDTH="52" VISIBLE="true" />
                        <COLUMN NAME="ghidra.util.table.field.FunctionSignatureTableColumn.Function Signature" WIDTH="118" VISIBLE="true" />
                        <COLUMN NAME="ghidra.util.table.field.FunctionBodySizeTableColumn.Function Size" WIDTH="210" VISIBLE="true" />
                        ...
                        <COLUMN NAME="ghidra.util.table.field.ReferenceCountToAddressTableColumn.Reference Count" WIDTH="190" VISIBLE="true" />
            ...
            <PREFERENCE_STATE NAME="ghidra.features.bsim.gui.search.dialog.BSimServerTableModel:Name:Type:Host:Port:User:Active/Idle Connections:">
                <XML NAME="COLUMN_DATA">
                    <Table_State>
                        <COLUMN NAME="ghidra.features.bsim.gui.search.dialog.BSimServerTableModel$DatabaseNameColumn.Name" WIDTH="153" VISIBLE="true" />
                        <COLUMN NAME="ghidra.features.bsim.gui.search.dialog.BSimServerTableModel$TypeColumn.Type" WIDTH="63" VISIBLE="true" />
                        <COLUMN NAME="ghidra.features.bsim.gui.search.dialog.BSimServerTableModel$HostColumn.Host" WIDTH="116" VISIBLE="true" />
                        <COLUMN NAME="ghidra.features.bsim.gui.search.dialog.BSimServerTableModel$PortColumn.Port" WIDTH="48" VISIBLE="true" />
                        <COLUMN NAME="ghidra.features.bsim.gui.search.dialog.BSimServerTableModel$UserInfoColumn.User" WIDTH="78" VISIBLE="true" />
                        <COLUMN NAME="ghidra.features.bsim.gui.search.dialog.BSimServerTableModel$ConnectionStatusColumn.Active/Idle Connections" WIDTH="116" VISIBLE="true" />
                        <TABLE_SORT_STATE>
                            <COLUMN_SORT_STATE COLUMN_MODEL_INDEX="0" SORT_DIRECTION="ascending" SORT_ORDER="1" />
                        </TABLE_SORT_STATE>
                    </Table_State>
            ...
            <PREFERENCE_STATE NAME="ghidra.framework.plugintool.dialog.KeyBindingsPanel$KeyBindingsTableModel:Action Name:KeyBinding:Plugin Name:">
                <XML NAME="COLUMN_DATA">
                    <Table_State>
                        <COLUMN NAME="Action Name" WIDTH="151" VISIBLE="true" />
                        <COLUMN NAME="KeyBinding" WIDTH="289" VISIBLE="true" />
                        <COLUMN NAME="Plugin Name" WIDTH="289" VISIBLE="true" />
                        <TABLE_SORT_STATE>
                            <COLUMN_SORT_STATE COLUMN_MODEL_INDEX="0" SORT_DIRECTION="ascending" SORT_ORDER="1" />
                        </TABLE_SORT_STATE>
                    </Table_State>
            ...
            <PREFERENCE_STATE NAME="ghidra.app.plugin.core.strings.ViewStringsTableModel:Location:String Value:String Representation:Data Type:">
                <XML NAME="COLUMN_DATA">
                    <Table_State>
                        <COLUMN NAME="ghidra.app.plugin.core.strings.ViewStringsTableModel$DataLocationColumn.Location" WIDTH="170" VISIBLE="true" />
                        <COLUMN NAME="ghidra.app.plugin.core.strings.ViewStringsTableModel$DataValueColumn.String Value" WIDTH="170" VISIBLE="true" />
                        <COLUMN NAME="ghidra.app.plugin.core.strings.ViewStringsTableModel$StringRepColumn.String Representation" WIDTH="170" VISIBLE="true" />
                        <COLUMN NAME="ghidra.app.plugin.core.strings.ViewStringsTableModel$DataTypeColumn.Data Type" WIDTH="169" VISIBLE="false" />
                        ...
                        <COLUMN NAME="ghidra.util.table.field.FunctionPurgeTableColumn.Function Purge" WIDTH="500" VISIBLE="false" />
                        <COLUMN NAME="ghidra.util.table.field.NamespaceTableColumn.Namespace" WIDTH="500" VISIBLE="false" />
                        <COLUMN NAME="ghidra.util.table.field.ReferenceCountToAddressTableColumn.Reference Count" WIDTH="169" VISIBLE="true" />
                        <COLUMN NAME="ghidra.util.table.field.IsFunctionCustomStorageTableColumn.Custom Storage" WIDTH="500" VISIBLE="false" />
                        <COLUMN NAME="ghidra.util.table.field.FunctionParameterCountTableColumn.Param Count" WIDTH="500" VISIBLE="false" />
                        <COLUMN NAME="ghidra.util.table.field.MemorySectionProgramLocationBasedTableColumn.Mem Block" WIDTH="500" VISIBLE="false" />
        ...
        <EXTENSIONS>
            <EXTENSION NAME="codecut-gui" />
            <EXTENSION NAME="GhidrAssistMCP" />
            <EXTENSION NAME="deepcut-ghidra" />
            <EXTENSION NAME="GhidrAssist" />
        </EXTENSIONS>
    </TOOL>
</TOOL_CONFIG>
